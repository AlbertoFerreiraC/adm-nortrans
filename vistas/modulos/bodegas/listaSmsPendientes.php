<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Consulta: Lista SMS Pendientes
        </h1>
        <ol class="breadcrumb">
            <li class="active"> Lista SMS Pendientes</li>
        </ol>
    </section>
