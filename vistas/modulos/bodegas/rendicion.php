    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header with-border">
                ...
                <div class="form-group col-sm-3 col-xs-12 ">
                    <button class="btn btn btn-block btn-info" data-toggle="modal" data-target="#modalAgregarProveedor">
    ...
    <div class="modal-dialog">
        ...
        ======================================-->
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" style="background-color: #adaf9c; border-color: #f46717; " id="btnGuardarProveedor"><i class="fa fa-hdd-o" aria-hidden="true"></i> Guardar</button>
