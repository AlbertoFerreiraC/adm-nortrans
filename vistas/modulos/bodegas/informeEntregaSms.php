<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Consulta: Informe Entrega de SMS
        </h1>
        <ol class="breadcrumb">
            <li class="active">Informe Entrega de SMS</li>
        </ol>
    </section>
                    ...
                    <table class="table table-bordered table-striped dt-responsive" id="tabla" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th style="cursor: pointer; position: relative; user-select: none; padding-right: 20px;" onclick="sortTable(10, this)">
                                    <center>Tipo Apliccion</center>
                                </th> 
                                <th style="cursor: pointer; position: relative; user-select: none; padding-right: 20px;" onclick="sortTable(11, this)">
                                    <center>Aplicacion</center>
                                </th>
                                <th style="cursor: pointer; position: relative; user-select: none; padding-right: 20px;" onclick="sortTable(12, this)">
                                    <center>Centro Costo</center>
                                </th>
                                <th style="cursor: pointer; position: relative; user-select: none; padding-right: 20px;" onclick="sortTable(13, this)">
