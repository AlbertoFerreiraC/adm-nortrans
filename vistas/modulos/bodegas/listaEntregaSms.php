<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Consulta: Lista Entrega de SMS
        </h1>
        <ol class="breadcrumb">
            <li class="active">Lista Entrega de SMS</li>
        </ol>
    </section>
