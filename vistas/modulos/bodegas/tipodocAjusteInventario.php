<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            Administrar Documento de Tipo de Ajuste de Inventario
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Administrar Documento de Tipo de Ajuste de Inventario</li>
...
<script src="vistas/js/bodegas/tipodocAjusteInventario.js"></script>
