                                        ...
                                        <table id="tablaDocumentos" class="table table-bordered table-striped dt-responsive" width="100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th onclick="sortTable(0, this)" <center>N° Solicitud</center>
                                                    </th>
                                                    <th onclick="sortTable(1, this)" <center>Fecha solicitud</center>
                                                    </th>
                                                    <th onclick="sortTable(2, this)" <center>Empresa</center>
                                                    </th>
                                                    <th onclick="sortTable(3, this)" <center>Cargo</center>
                                                    </th>
                                                    <th onclick="sortTable(4, this)" <center>Centro costo</center>
                                                    </th>
                                                    <th onclick="sortTable(6, this)" <center>Pre aprobado</center>
                                                    </th>
                                                    <th onclick="sortTable(7, this)" <center>Aprobado</center>
                                                    </th>
                                                    <th onclick="sortTable(8, this)" <center>Tipo contrato</center>
                                                    </th>
                                                    <th onclick="sortTable(9, this)" <center>Estado actual</center>
                                                    </th>
