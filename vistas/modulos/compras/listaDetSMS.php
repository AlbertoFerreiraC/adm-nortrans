<div class="content-wrapper">
    <section class="content-header" style="background-color: black; padding: 20px; text-align: center;">
        <h1 style="color: white; font-weight: bold;">Consulta: Consulta lista detalle SMS</h1>
    </section>
                                    ...
                                    <div class="box-body">
                                        <div id="lista">
                                            <table id="tablaDocumentos" class="table table-bordered table-striped dt-responsive" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th onclick="sortTable(0, this)">Fecha SMS</th>
                                                        <th onclick="sortTable(1, this)">Estado SMS</th>
                                                        <th onclick="sortTable(2, this)">Tipo SMS</th>
                                                        <th onclick="sortTable(3, this)">N° SMS</th>
                                                        <th onclick="sortTable(4, this)">Item SMS</th>
                                                        <th onclick="sortTable(5, this)">Aplicacion</th>
                                                        <th onclick="sortTable(6, this)">Tipo Producto</th>
                                                        <th onclick="sortTable(8, this)">Id Producto</th>
                                                        <th onclick="sortTable(8, this)">Producto</th>
                                                        <th onclick="sortTable(7, this)">U.M.</th>
                                                        <th onclick="sortTable(8, this)">Cantidad</th>
                                                        <th onclick="sortTable(9, this)">Costo Unitario</th>
                                                        <th onclick="sortTable(10, this)">Solicitante</th>
                                                        <th onclick="sortTable(11, this)">Centro Costo</th>
                                                        <th onclick="sortTable(12, this)">Estado Item</th>
                                                        <th onclick="sortTable(13, this)">N° Salida</th>
                                                        <th onclick="sortTable(14, this)">Cantidad Entregada</th>
                                                        <th onclick="sortTable(15, this)">Fecha Salida Bodega</th>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                            </table>
