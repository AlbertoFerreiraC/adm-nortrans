<div class="content-wrapper">
    <section class="content-header" style="background-color: black; padding: 20px; text-align: center;">
        <h1 style="color: white; font-weight: bold;">Consulta: Consulta Lista de SMS</h1>
    </section>
                                            ...
                                            <table id="tablaDocumentos" class="table table-bordered table-striped dt-responsive" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th onclick="sortTable(1, this)">N° SMS</th>
                                                        <th onclick="sortTable(2, this)">Fecha</th>
                                                        <th onclick="sortTable(3, this)">Tipo de Solicitud</th>
                                                        <th onclick="sortTable(4, this)">Rut Solicitante</th>
                                                        <th onclick="sortTable(5, this)">Solicitante</th>
                                                        <th onclick="sortTable(6, this)">Pre Aprobado</th>
