<div class="content-wrapper">
    <section class="content-header" style="background-color: black; padding: 20px; text-align: center;">
        <h1 style="color: white; font-weight: bold;">Consulta: Historial de compra proveedor</h1>
    </section>
                                            ...
                                            <table id="tablaDocumentos" class="table table-bordered table-striped dt-responsive" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th onclick="sortTable(3, this)">Tipo Documento</th>
                                                        <th onclick="sortTable(4, this)">Monto Neto</th>
                                                        <th onclick="sortTable(5, this)">Estado</th>
                                                        <th onclick="sortTable(6, this)">Ver OC</th>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                            </table>
