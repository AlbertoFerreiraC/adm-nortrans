<div class="content-wrapper">
    <section class="content-header" style="background-color: black; padding: 20px; text-align: center;">
        <h1 style="color: white; font-weight: bold;">Consulta: Historial de compra repuesto</h1>
    </section>
                                    ...
                                    <div class="box-body">
                                        <div id="lista">
                                            <table id="tablaDocumentos" class="table table-bordered table-striped dt-responsive" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th onclick="sortTable(0, this)">Fecha OC</th>
                                                        <th onclick="sortTable(1, this)">N° OC</th>
                                                        <th onclick="sortTable(2, this)">N° Item</th>
                                                        <th onclick="sortTable(3, this)">Costo Unitario</th>
                                                        <th onclick="sortTable(4, this)">Cantidad</th>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                            </table>
...
<script src="vistas/js/compras/historialRepuesto.js"></script>
