<div class="content-wrapper">
    <section class="content-header" style="background-color: black; padding: 20px; text-align: center;">
        <h1 style="color: white; font-weight: bold;">Consulta: Consulta Solicitud Material y Servicio</h1>
    </section>
                                    ...
                                    <div class="box-body">
                                        <div id="lista">
                                            <table id="tablaDocumentos" class="table table-bordered table-striped dt-responsive" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th onclick="sortTable(0, this)">N° Item</th>
                                                        <th onclick="sortTable(1, this)">Aplicaciones</th>
                                                        <th onclick="sortTable(2, this)">Centro Costo</th>
                                                        <th onclick="sortTable(3, this)">Tipo Item</th>
                                                        ...
                                                        <th onclick="sortTable(12, this)">Estado</th>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                            </table>
