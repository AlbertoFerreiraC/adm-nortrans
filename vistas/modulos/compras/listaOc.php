                                            ...
                                            <table id="tablaDocumentos" class="table table-bordered table-striped dt-responsive" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th onclick="sortTable(2, this)">Tipo OC</th>
                                                        <th onclick="sortTable(3, this)">Fecha</th>
                                                        <th onclick="sortTable(4, this)">Rut Proveedor</th>
                                                        <th onclick="sortTable(5, this)">Proveedor</th>
                                                        <th onclick="sortTable(6, this)">Plazo de Pago</th>
                                                        <th onclick="sortTable(7, this)">Forma de Pago</th>
                                                        <th onclick="sortTable(8, this)">Tipo Doc. Prov.</th>
                                                        <th onclick="sortTable(9, this)">N° Doc. Prov.</th>
                                                        <th onclick="sortTable(10, this)">Monto Total</th>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                            </table>
