<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            Administrar Tipo de Secuencia de Pauta
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Administrar Tipo de Secuencia de Pauta</li>
...
<script src="vistas/js/mantencion/secuenciaPauta.js"></script>
