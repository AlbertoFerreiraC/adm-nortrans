...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Administrar Registro de Kilometraje</h1>
        <ol class="breadcrumb">
            <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio / Mantención</a></li>
            <li class="active">Registro de Kilometraje</li>
        </ol>
    </section>
        ...
        <div class="modal-content">
            <form role="form" method="post" id="formularioAgregarKilometraje">
                ...
                <div class="modal-header" style="background:#A9A9A9; color:white">
                    ...
                    <h4 class="modal-title">Nuevo Registro de Kilometraje</h4>
                </div>
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <h4><strong>Datos del Registro</strong></h4>
                        <hr>
...
<!-- SCRIPT EXTERNO -->
<script src="vistas/js/mantencion/registroKM.js"></script>