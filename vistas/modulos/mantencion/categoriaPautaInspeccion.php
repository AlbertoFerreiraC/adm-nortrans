<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            Administrar Tipo de Detencion Programada
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Administrar Tipo de Detencion Programada</li>
...
<script src="vistas/js/mantencion/categoriaPautaInspeccion.js"></script>
