<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            Administrar Sub Sistemas de la Máquina
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Administrar Sub Sistemas de la Máquina</li>
...
<script src="vistas/js/mantencion/subsistemaMaquina.js"></script>
