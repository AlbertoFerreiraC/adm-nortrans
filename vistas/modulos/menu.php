...
$('#btnBusquedaVentana').click(function() {   
	  ...
	  if(valor == "Cambiar Mi Contraseña"){ window.location.href = "actualizacionDatos"; }
	  if(valor == "Nacionalidad"){ window.location.href = "nacionalidad"; }
	  if(valor == "Comuna"){ window.location.href = "comuna"; }
	  if(valor == "AFP"){ window.location.href = "afp"; }
	  if(valor == "Salud"){ window.location.href = "salud"; }
	  if(valor == "Turnos Laborales"){ window.location.href = "turnosLaborales"; }
	  if(valor == "Empresa"){ window.location.href = "empresa"; }
	  if(valor == "Documentos"){ window.location.href = "docuemnto"; }
	  if(valor == "Tipo EPP"){ window.location.href = "tipoEpp"; }

	  if(valor == "Ficha Empleado"){ window.location.href = "fichaEmpleado"; }
	  if(valor == "Centro de Costo"){ window.location.href = "centroDeCosto"; }
	  if(valor == "Antecedentes Médicos"){ window.location.href = "antecedentesMedicos"; }
	  if(valor == "Usuario"){ window.location.href = "usuario"; }
  });

</script>

<style>
  .ui-autocomplete { height: 280px; overflow-y: scroll; overflow-x: hidden;}
  .ui-autocomplete {
    z-index:2147483647;
  }
</style>