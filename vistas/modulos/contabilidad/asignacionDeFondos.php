...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            Gestionar Asignaciones de Fondo para Rendición
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Gestionar Asignaciones de Fondo para Rendición</li>
    ...
    <div class="modal-dialog modal-lg">
        ...
        ======================================-->
                ...
                <div class="modal-header" style="background:#A9A9A9; color:white">
                    ...
                    <h4 class="modal-title">Nueva Asignación de Fondos</h4>
        ...
        ======================================-->
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-4 col-xs-12">
                            <label for="otorgarAgregar">Otorgar A:</label><span style="font-size: 11px; color: #DC3139;"> (Obligatorio)</span>
                            <select class="form-control input-md cajatexto" name="otorgarAgregar" id="otorgarAgregar"></select>
                        </div>

                        <div class="form-group col-md-4 col-xs-12">
                            <label for="montoSolicitadoAgregar">Monto Solicitado:</label><span style="font-size: 11px; color: #DC3139;"> (Obligatorio)</span>
                            <input type="text" class="form-control input-md cajatexto solo-numero puntos_de_mil" name="montoSolicitadoAgregar" id="montoSolicitadoAgregar">
                        </div>
                        ...
                        <div class="form-group col-md-4 col-xs-12">
                            ...
                            <select class="form-control input-md cajatexto" name="apruebaAgregar" id="apruebaAgregar"></select>
                        </div>

                        <div class="form-group col-sm-12 col-xs-12">
                            <label for="motivoAgregar">Motivo de la Asiganación:</label><span style="font-size: 11px; color: #DC3139;"> (Obligatorio)</span>
                            <textarea class="form-control input-md cajatexto" name="motivoAgregar" id="motivoAgregar" rows="2"></textarea>
                        </div>
                    </div>
                </div>
        ...
        ======================================-->
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" style="background-color: #adaf9c; border-color: #f46717; " id="btnGuardar"><i class="fa fa-hdd-o" aria-hidden="true"></i> Procesar Asignación</button>
                </div>
                    ...
                    <div class="box-body">
                           ...
                           <div class="form-group col-md-4 col-xs-12">
                            ...
                            <div class="form-group col-sm-6 col-xs-12">
                                ...
                                <textarea class="form-control input-md cajatexto" name="observacionAprobacion" id="observacionAprobacion" rows="2" readonly></textarea>
                            </div>
...
<script src="vistas/js/contabilidad/asignacionDeFondos.js"></script>
