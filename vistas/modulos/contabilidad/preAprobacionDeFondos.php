...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            Gestionar Pre Aprobación de Fondo para Rendición
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Gestionar Pre Aprobación de Fondo para Rendición</li>
    ...
    <div class="modal-dialog modal-lg">
        ...
        ======================================-->
                    ...
                    <div class="box-body">
                           ...
                           <div class="form-group col-md-4 col-xs-12">
                            ...
                            <div class="form-group col-sm-6 col-xs-12">
                                ...
                                <textarea class="form-control input-md cajatexto" name="observacionPreAprobacion" id="observacionPreAprobacion" rows="2"></textarea>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success  pull-rigth" id="btnAprobarSolicitud"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Pre Aprobar Asignación</button>
...
<script src="vistas/js/contabilidad/preAprobacionDeFondos.js"></script>
