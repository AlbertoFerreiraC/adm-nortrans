<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio/Contabilidad</a></li>
      
      <li class="active">Administrar Criticidad</li>
...
<script src="vistas/js/contabilidad/criticidad.js"></script>
