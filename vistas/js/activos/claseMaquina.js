...
function obtenerDatosParaModificar(valor) {
  ...
  $.ajax({
    url: "../api_adm_nortrans/claseMaquina/funDatosParaModificar.php",
    method: "POST",
    cache: false,
    data: JSON.stringify(params),
    contentType: false,
...
function modificarDatos() {
  ...
  $.ajax({
    url: "../api_adm_nortrans/claseMaquina/funModificar.php",
    method: "POST",
    cache: false,
    data: JSON.stringify(params),
    contentType: false,
...
function eliminarDatos(valor) {
  ...
  $.ajax({
    url: "../api_adm_nortrans/claseMaquina/funEliminar.php",
    method: "POST",
    cache: false,
    data: JSON.stringify(params),
    contentType: false,
