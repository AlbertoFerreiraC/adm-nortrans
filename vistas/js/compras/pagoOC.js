...
function agregarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/pagoOC/funAgregar.php",
        method: "POST",
        cache: false,
...
function obtenerDatosParaModificar(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/pagoOC/funDatosParaModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function modificarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/pagoOC/funModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function eliminarDatos(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/pagoOC/funEliminar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
