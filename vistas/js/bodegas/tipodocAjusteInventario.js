...
function cargarDatosTabla() {
    ...
    var fila = "";
    $.ajax({
        url: "../api_adm_nortrans/tipodocAjusteInventario/funListar.php",
        method: "GET",
        cache: false,
        contentType: false,
        processData: false,
...
function agregarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/tipodocAjusteInventario/funAgregar.php",
        method: "POST",
        cache: false,
...
function obtenerDatosParaModificar(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/tipodocAjusteInventario/funDatosParaModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function modificarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/tipodocAjusteInventario/funModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function eliminarDatos(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/tipodocAjusteInventario/funEliminar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
