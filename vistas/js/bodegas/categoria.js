...
function agregarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/categoria/funAgregar.php",
        method: "POST",
        cache: false,
...
function obtenerDatosParaModificar(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/categoria/funDatosParaModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function modificarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/categoria/funModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function eliminarDatos(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/categoria/funEliminar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
