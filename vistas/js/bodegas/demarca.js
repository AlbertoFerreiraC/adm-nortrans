...
function cargarDatosTabla() {
    ...
    var fila = "";
    $.ajax({
        url: "../api_adm_nortrans/demarca/funListar.php",
        method: "GET",
        cache: false,
        contentType: false,
        processData: false,
...
function agregarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/demarca/funAgregar.php",
        method: "POST",
        cache: false,
...
function obtenerDatosParaModificar(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/demarca/funDatosParaModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function modificarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/demarca/funModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function eliminarDatos(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/demarca/funEliminar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
