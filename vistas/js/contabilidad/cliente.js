...
function cargarDatosTabla() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/cliente/funListar.php",
        method: "GET",
        cache: false,
        contentType: false,
        processData: false,
        ...
        success: function (response) {
            if (response.length === 0) {
                ...
                for (var i in response) {
                    ...
                    fila += '<td>' + response[i].telefono + '</td>';
...
function agregarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/cliente/funAgregar.php",
        method: "POST",
        cache: false,
...
function obtenerDatosParaModificar(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/cliente/funDatosParaModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function modificarDatos() {
    ...
    $.ajax({
        url: "../api_adm_nortrans/cliente/funModificar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
...
function eliminarDatos(valor) {
    ...
    $.ajax({
        url: "../api_adm_nortrans/cliente/funEliminar.php",
        method: "POST",
        cache: false,
        data: JSON.stringify(params),
        contentType: false,
